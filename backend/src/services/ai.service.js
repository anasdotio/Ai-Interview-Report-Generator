...
async function generateResumePdf({ resume, selfDescription, jobDescription }) {
  ...
  const prompt = `Generate a resume  for a candidate with the following details
        ...
        the resume should be tailored for the given job description and should highlighted the candidate's strengths and relevant experience. The HTML content should be well-formatted and structured, making it easy to read.
